...
func (j JianShu) Run(name string) string {
	...
	// curl 'https://www.jianshu.com/search/do?q=vim&type=note&page=1&order_by=default' \
	//   -X 'POST' \
	//   -H 'Connection: keep-alive' \
	//   -H 'Content-Length: 0' \
	//   -H 'sec-ch-ua: "Chromium";v="92", " Not A;Brand";v="99", "Google Chrome";v="92"' \
	//   -H 'Accept: application/json' \
	//   -H 'X-CSRF-Token: YE+WpV8Dkpb8lxrYtRlPqi2MeAG7KgUBLwyk/9V+K09htk9sETMHpNgg6OP7htfBcIMqtU17Fcsj4YZlMGPJuQ==' \
