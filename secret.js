...
function s(e) {
    return (s = "function" == typeof Symbol && "symbol" == typeof Symbol.t ?
        function(e) {
            return typeof e
        }: function(e) {
...
i.prototype.M = function(e) {
    ...
    B.prototype.M = function(t) {
        switch (this.s) {
            ...
            case 2:
                var A = t.f.pop();
                if(A == "window"){  // 构造 window
                    var window = {
                        // 对url进行编码
                        'encodeURIComponent': function(url){
                            var newUrl = url.replace(/\%/g, "%25").replace(/\=/g, '%3D').replace(/\&/g, "%26");
                            return newUrl;
                        }
                    };
                    A = window;
                }else if (A == "navigator"){  // 构造 navigator
                    A = {
    ...
    g.prototype.M = function(e) {
        switch (this.s) {
            case 0:
                ...
                break;
            case 1:
                for (var o = [], i = 0; i < this.h; i++) o.unshift(e.f.pop());
                e.c[this.i] = o
        }
    },
